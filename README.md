...
The `kubetest-junit` module combines all the provided functionality of test-frame into a single, easy-to-use JUnit 5 extension. This extension provides a **declarative approach** to Kubernetes testing with best-practice configurations out of the box.
