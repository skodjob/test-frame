 ...
 */
class RequiresKubernetesConditionTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(RequiresKubernetesConditionTest.class);
...
class KubernetesOnlyTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(KubernetesOnlyTest.class);
