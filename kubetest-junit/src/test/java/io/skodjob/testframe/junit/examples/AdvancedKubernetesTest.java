...
class AdvancedKubernetesTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(AdvancedKubernetesTest.class);
    ...
    void setupSharedResources() {
        LOGGER.info("Setting up shared resources for test in namespace: {}", namespaceName);
