...
@RequiresKubernetes
@KubernetesTest(
    namespace = "resource-injection-test",
...
class ResourceInjectionTest {
    ...
    @InjectResource("src/test/resources/test-deployment.yaml")
    ...
    @Test
    void testParameterInjection(@InjectResource("src/test/resources/test-deployment.yaml") Deployment paramDeployment,
    ...
    void testResourcesHaveCorrectConfiguration() {
        ...
        assertEquals("test-value", container.getEnv().get(0).getValue());
