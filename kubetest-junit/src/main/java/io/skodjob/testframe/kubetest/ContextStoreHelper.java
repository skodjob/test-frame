 ...
 * This eliminates the repeated boilerplate code for context store operations
 * and provides type-safe access to stored test data.
 */
class ContextStoreHelper {

    // Extension context store keys (moved from KubernetesTestExtension)
    ...
    // Multi-context extension store keys
    ...
    /**
     * Get a value from the extension context store.
     */
    ...
    /**
     * Put a value in the extension context store.
     */
    ...
    /**
     * Get a value from the extension context store with generic type (requires casting).
     */
    ...
    /**
     * Gets the test configuration from the extension context.
     */
    ...
    /**
     * Stores the test configuration in the extension context.
     */
    ...
    /**
     * Gets the resource manager from the extension context.
     */
    ...
    /**
     * Stores the resource manager in the extension context.
     */
    ...
    /**
     * Gets the log collector from the extension context.
     */
    ...
    /**
     * Stores the log collector in the extension context.
     */
    ...
    /**
     * Gets the namespace objects map from the extension context.
     */
    ...
    /**
     * Stores the namespace objects map in the extension context.
     */
    ...
    /**
     * Gets the namespace names array from the extension context.
     */
    public String[] getNamespaces(ExtensionContext context) {
        return getUnchecked(context, NAMESPACE_KEY);
    }

    /**
     * Stores the namespace names array in the extension context.
     */
    ...
    /**
     * Gets the list of created namespace names from the extension context.
     */
    ...
    /**
     * Stores the list of created namespace names in the extension context.
     */
    ...
    /**
     * Gets the created namespace flag from the extension context.
     */
    public boolean getCreatedNamespaceFlag(ExtensionContext context) {
        Boolean flag = get(context, CREATED_NAMESPACE_KEY, Boolean.class);
        return flag != null && flag;
    }

    /**
     * Stores the created namespace flag in the extension context.
     */
    ...
    /**
     * Gets the primary context closer from the extension context.
     */
    public AutoCloseable getContextCloser(ExtensionContext context) {
        return get(context, "context.closer", AutoCloseable.class);
    }

    /**
     * Stores the primary context closer in the extension context.
     */
    public void putContextCloser(ExtensionContext context, AutoCloseable contextCloser) {
        put(context, "context.closer", contextCloser);
    }
    ...
    /**
     * Get or create a map from the context store with automatic initialization.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Gets or creates the map of context managers.
     */
    ...
    /**
     * Gets or creates the map of context closers.
     */
    ...
    /**
     * Gets or creates the map of context namespace objects.
     */
    ...
    /**
     * Gets or creates the map of context created namespaces.
     */
