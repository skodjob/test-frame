...
class ConfigurationManager {
    ...
    public TestConfig createTestConfig(ExtensionContext context, KubernetesTest annotation) {
        ...
        TestConfig.ContextMappingConfig[] contextMappings =
            new TestConfig.ContextMappingConfig[annotation.contextMappings().length];
        for (int i = 0; i < annotation.contextMappings().length; i++) {
            contextMappings[i] = TestConfig.ContextMappingConfig.fromAnnotation(annotation.contextMappings()[i]);
        }
